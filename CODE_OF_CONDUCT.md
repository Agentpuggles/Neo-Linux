...
* Publishing others' private information — such as a physical or email address, a game
  account name, or a session token — without their explicit permission
...
comments, code, wiki edits, issues, and other contributions that are not aligned to
...
discussions and this repository's Discord-adjacent chatter — and also applies when an
...
[private security advisory](https://github.com/Agentpuggles/Neo-Linux/security/advisories/new)
so the report is not public, or by using the contact route described in
